...
docker pull 637423298319.dkr.ecr.us-west-2.amazonaws.com/manu/application-services:latest

# Deploy the Docker stack
echo "Deploying Docker stack..."
docker stack deploy -c docker-stack.yml manu-application-services-stack || { echo "Failed to deploy Docker stack"; exit 1; }

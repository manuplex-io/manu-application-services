...
export class GoogleSheetService {
  ...
  async addNewTabAndPopulateData(
    ...
    const populateDataRequest = {
      updateCells: {
        rows,
        start: {
          sheetId: null /* This will be set dynamically */,
          rowIndex: 0,
          columnIndex: 0,
        },
        fields: 'userEnteredValue',
        ...
        requests: [
          ...
          // Add borders to all filled cells
          {
            updateBorders: {
              ...
              }, // Black border for top
              bottom: {
                style: 'SOLID',
                width: 1,
                color: { red: 0, green: 0, blue: 0 },
              }, // Black border for bottom
              left: {
                style: 'SOLID',
                width: 1,
                color: { red: 0, green: 0, blue: 0 },
              }, // Black border for left
              right: {
                style: 'SOLID',
                width: 1,
                color: { red: 0, green: 0, blue: 0 },
              }, // Black border for right
    ...
    console.log(
      `New tab '${sheetName}' created, populated and column widths set with wrap formatting.`,
    );

    const spreadsheetUrl = `https://docs.google.com/spreadsheets/d/${spreadsheetId}/edit#gid=${newSheetId}`;
    console.log(
      `Spreadsheet URL with direct access to new tab: ${spreadsheetUrl}`,
    );
